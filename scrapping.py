...
def extract_movie_details(movie_link):
    ...
    if movie_soup is not None:
        title = None
        date = None
        # Utilize as class para ajustar o trecho abaixo de acordo com o site de um filme, exemplo : https://www.imdb.com/title/tt4919268/?ref_=hm_tpks_tt_t_1_pd_tp1_pbr_ic, usar inspecionar elemento para definir os elementos.
